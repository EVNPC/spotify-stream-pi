...
public class playsong extends NormalAction
{
    ...
    {
        AddItemToUsersPlaybackQueueRequest_Sync();
    }
    
    public class AddItemToUsersPlaybackQueueExample {
        Property token = getClientProperties().getSingleProperty("spotifyToken");
        Property url = getClientProperties().getSingleProperty("spotifySongURL");
        private final String accessToken = token.getStringValue();
        private final String trackUri = url.getStringValue();
      
        private final SpotifyApi spotifyApi = new SpotifyApi.Builder()
          .setAccessToken(accessToken)
          .build();
        private final AddItemToUsersPlaybackQueueRequest addItemToUsersPlaybackQueueRequest = spotifyApi
          .addItemToUsersPlaybackQueue(trackUri)
      //    .device_id("5fbb3ba6aa454b5534c4ba43a8c7e8e45a63ad0e")
          .build();
      
        public void addItemToUsersPlaybackQueue_Sync() {
          try {
